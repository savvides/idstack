...
```bash
~/.claude/skills/idstack/bin/idstack-timeline-log '{"skill":"course-import","event":"completed"}'
```
...
```bash
~/.claude/skills/idstack/bin/idstack-learnings-log '{"skill":"course-import","type":"operational","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":8,"source":"observed"}'
```
