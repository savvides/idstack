/**
 * Consensus evidence client and background QA pass for Chrome extension (CommonJS).
...
function detectNeuromyth(finding) {
...
function autoCorrectNeuromyth(finding, mythType) {
...
function formatConsensus(record) {
 ...
 */
async function verifyFindingsWithConsensus(findings, apiKey, storage = null) {
