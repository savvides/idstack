...
The shared preamble includes: update check, manifest check, and context recovery (reads timeline + learnings for welcome-back messages and pipeline guidance).
