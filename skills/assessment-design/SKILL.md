...
- **Read this:** `.idstack/reports/assessment-design.md` — the assessment plan, the
  feedback-quality score with evidence-backed findings, and per-rubric alignment notes.
